        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-500 via-pink-500 to-red-500">
            ...
            <div className="w-full max-w-md p-4 bg-white rounded-lg shadow-md">
                ...
                <p className="text-gray-500 text-sm mt-6 text-center">
                    Disclaimer: By clicking the "Create Account" button, you
                    agree to our terms and conditions, which include giving us
                    access to your personal data for all eternity. Just kidding,
                    we won't do that. Or will we?
                </p>
            </div>
        </div>
    );
