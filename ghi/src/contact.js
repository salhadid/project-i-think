    ...
    return (
        <div className="relative mx-auto py-10 px-4 w-full max-w-7xl bg-gray-50 pt-20">
            ...
            <div className="relative space-y-5">
                ...
                iThink is an AI-powered brainstorming collaboration tool that
                helps teams generate and refine ideas quickly and efficiently.
                Contact us to learn more about how iThink can help your team
