...
const Faq = () => {
    const faq = [
        ...
        answer:
            "The AI will reply with a recipe for a delicious sandwich. Sorry, we're still working on the world hunger thing.",
        },
        {
        number: 2,
        question: "Can the AI make me rich and famous?",
        answer:
            "Sure, just give it all your personal information, your credit card numbers, and your firstborn child. What could go wrong?",
        },
        {
        number: 3,
        ...
        answer:
            "Of course! Just tell it your ideal partner's name, address, social security number, and blood type, and the AI will do the rest. It's not like that's creepy or anything.",
        },
        {
        number: 5,
        question: "What if the AI becomes self-aware and takes over the world?",
        answer:
            "Don't worry, we have a contingency plan: we'll unplug it and plug it back in again. That always works, right?",
        },
    ];
