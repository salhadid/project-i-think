...
function AI() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await axios.post(
            `${process.env.REACT_APP_iThink}/chat`,
            {
                message: prompt,
    ...
    const handleSubmitYes = async () => {
        ...
        for (let message of yesList) {
            axios.post(
                `${process.env.REACT_APP_iThink}/api/projects/${selectedProject}/add_response`,
                message,
                {
                    headers: {
