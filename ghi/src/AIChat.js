...
const AIChat = () => {
    ...
    const [messages, setMessages] = useState([
        { message: "Hiya! Let's come up with some ideas together!", type: "thinkbot" },
    ]);
    ...
    const sendMessage = (event) => {
        ...
        setLoading(true);
        axios
        .post("http://localhost:8000/chat", { message: input })
        .then((res) => {
            setMessages([
            ...messages,
    ...
    <div className="flex flex-col h-full bg-gray-100">
        ...
        {messages.map((message, index) => (
            ...
            className={`flex flex-col ${
                message.type === "thinkbot" ? "items-start" : "items-end"
            } mb-2`}
            >
...
//             setMessages([
//             ...messages,
//             { message: input, type: "user" },
//             { message: res.data.answer, type: "ai" },
//             ]);
//             setInput("");
//             setLoading(false);
//         })
...
//         {loading && <ClipLoader color="#00BFFF" size={50} />}
//         {messages.map((message, index) => (
//             <p
//             key={index}
...
//             value={input}
//             onChange={(e) => setInput(e.target.value)}
//             placeholder="Let's come up with an idea together!"
//             className="border rounded-md px-2 py-1 w-full"
//             />
//             <button
//             type="submit"
//             className="mt-2 bg-purple-500 text-white rounded-md px-4 py-2"
//             >
//             Send
//             </button>
//         </form>
